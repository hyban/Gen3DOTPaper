...
multi-spectral imaging,simultaneous frequency domain and continuous-wave data acquisition through
heterodyne detection and profilometery. The performance of our system is measured using solid phantoms and clinical data.  
\end{abstract}
...
Diffuse optical tomography. Since OSA does not routinely perform copyediting and typesetting for this journal, use of the template is critical to providing a consistent appearance. Proper reference format is especially important (see Section \ref{sec:refs}).
