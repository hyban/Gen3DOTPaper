A style guide, template, and style file are provided for OSA express journal
manuscript submissions in LaTeX. 

OpEx_style.tex: LaTeX style guide and template
opexfig1.eps:	Sample .eps figure
opexfig2.eps:   Sample .eps figure capture of a multimedia file
...
Contact Theresa Miller (tmiller@osa.org) with any questions.
